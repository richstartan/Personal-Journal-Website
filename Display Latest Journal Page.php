...
<head>
	<title>Richie's Personal Journal Website - Latest Journal Entries</title>
	<link rel="stylesheet" type="text/css" href="CSS/Display Latest Journal Page.css">
...
<body>
    ...
    <a class="text-white" href="Display Earliest Journal Page.php"><button class="btn btn-outline-success my-2 my-sm-0" type="submit">Sort Entries by Earliest Date</a></button>
...
<!-- Navigation Breadcrumb -->
    ...
    <li class="breadcrumb-item active">LATEST JOURNAL ENTRIES</li>
    </ol>
    </nav>
...
<div class="animate-bottom">
	<center><h1 class="entry-title">My Latest Journal Entries</h1></center>

    <div class="entries">
        <!-- Display Journal Entries from the database -->
<?php
    include('dbconfig/JournalDatabase.php');

    $sql = "SELECT * FROM journalentries ORDER BY dateandtime_entry DESC";
    ...
    if (mysqli_num_rows($result)<= 0){
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            "<td>"."<a title='Edit Journal Entry' class='btn btn-success' href='Update Journal Page.php?id=$row[ID]'>"."<i class='fas fa-edit'></i>"."</a>"

            ." <a title='Delete Journal Entry' class='btn btn-danger' href='Delete Journal.php?id=$row[ID]'>"."<i class='fas fa-trash-alt'></i>"."</td>"."</a>";
        }
        echo "</table>";
    }
?>
