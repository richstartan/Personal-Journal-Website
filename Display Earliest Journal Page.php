...
<head>
	<title>Richie's Personal Journal Website - Earliest Journal Entries</title>
	<link rel="stylesheet" type="text/css" href="CSS/Display Earliest Journal Page.css">
...
<body>
    ...
    <a class="text-white" href="Display Latest Journal Page.php"><button class="btn btn-outline-success my-2 my-sm-0" type="submit">Sort Entries by Latest Date</a></button>
...
<!-- Navigation Breadcrumb -->
    ...
    <li class="breadcrumb-item active">EARLIEST JOURNAL ENTRIES</li>
...
<div class="animate-bottom">
	<center><h1 class="entry-title">My Earliest Journal Entries</h1></center>
